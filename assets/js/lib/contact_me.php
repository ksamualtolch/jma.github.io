...
$businessName = strip_tags(htmlspecialchars($_POST['business']));
$industryType = strip_tags(htmlspecialchars($_POST['industry']));
...
$email_body = "You have received a new message via JMA Marketing\n\n"."Here are the details:\n\nName: $name\n\nPhone Number: $phone\n\nEmail: $email_address\n\nBusiness Name: $business\n\nIndustry Type: $industry\n\nMessage:\n$message";
